    ...
    return(
        ...
        <TransitionLink href={link}>
            <Windows95ButtonContainer>
                <div className="flex flex-col justify-center gap-[0.26rem] ml-[0.04rem] mt-[0.1rem] items-center ">
                    ...
                    <span className="font-Tiny5 w-[3.5rem] md:w-[4rem] text-sm text-center leading-none">{label}</span>
                </div>
            </Windows95ButtonContainer>
