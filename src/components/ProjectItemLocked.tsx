...
export const ProjectItemLocked: React.FC<ProjectItemProps> = ({name, company, description, date, link, image, prevProjLink, nextProjLink}) => {
    return(
        <div className="md:relative md:mr-[5rem] lg:mr-[16rem] xl:mr-[18rem] lg:max-w-[1024px]">
            <Windows95FrameOuter label={name}>
                ...
                <Windows95FrameInner>
                    <Image src={image} alt="Case study hero" className=""/>
                </Windows95FrameInner>
